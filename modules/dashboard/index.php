...
<?php foreach($logs as $i=>$g):$st2=Helper::logStyle($g['aktivitas']);?>
...
<div class="text-[13px] text-slate-800"><b><?=Security::e($g['nama']??'Sistem')?></b> <?=Security::e($g['aktivitas'])?> <span class="text-gray-400">• <?=Security::e($g['modul'])?><?=($g['record_id']?' #'.$g['record_id']:'')?></span></div>
