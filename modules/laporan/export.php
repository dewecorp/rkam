...
fputcsv($out,['Kegiatan','Bidang','Anggaran','Realisasi','Sisa','Persen','Status']);
foreach($rk->fetchAll() as $r){fputcsv($out,[$r['nama_kegiatan'],$r['nama_bidang']??'',$r['total_anggaran'],$r['jml_real'],$r['total_anggaran']-$r['jml_real'],Helper::persen($r['jml_real'],$r['total_anggaran']),$r['status']]);}
fclose($out);exit;
